...
<head>
    ...
    <!-- Title -->
    <title>Issue a Medical Report</title>
...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center fw-bold">Issue a Medical Report</h1>
        <form action="{{ route('doctor.createReport') }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="report_date" class="form-label">Report Date</label>
                <input type="date" id="report_date" name="report_date" class="form-control w-auto" required>
            </div>
            <div class="mb-3">
                <label for="content" class="form-label">Report Content</label>
                <textarea id="content" name="content" class="form-control w-auto" rows="4" required></textarea>
            </div>
            <div class="mb-3">
                <label for="session_id" class="form-label">Session</label>
                <select id="session_id" name="session_id" class="form-select w-auto" required>
    ...
    <!-- JavaScript to handle patient ID autofill -->
    <script>
